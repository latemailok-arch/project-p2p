# pingchat Privacy Policy

*Last updated: January 2025*

## Our Commitment

pingchat is designed with privacy as its foundation. We believe private communication is a fundamental human right. This policy explains how pingchat protects your privacy.
...
- **Hybrid Functionality** - pingchat offers two modes of communication:
...
## What Information pingchat Stores
...
During each session, pingchat temporarily maintains:
...
### With Other pingchat Users

When you use pingchat, nearby peers can see:
...
To provide the core functionality of pingchat, we access your device's location data. This access is necessary for the following specific purposes:
...
- **How we use it:** We use this permission strictly to discover other pingchat peers nearby for the "Bluetooth Mesh Chat" mode.
...
pingchat does not knowingly collect information from children. The app has no age verification because it collects no personal information from anyone.
...
pingchat is an open source project. For privacy questions:
- Review our code: https://github.com/yourusername/pingchat
- Open an issue on GitHub
- Join the discussion in public rooms

## Philosophy

Privacy isn't just a feature—it's the entire point. pingchat proves that modern communication doesn't require surrendering your privacy. No accounts, no servers, no surveillance. Just people talking freely.

---

*This policy is released into the public domain under The Unlicense, just like pingchat itself.*