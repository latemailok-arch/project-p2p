 ...
 *
 *   adb shell am broadcast -a com.pingchat.watch.TEST_HOOK \
 *     --es cmd <command> --es id <cmd-id> [command extras...]
 *
 * Result is written to cache/testhook/results/<id>.json (readable via run-as com.pingchat.watch)
...
class WearTestHookReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "com.pingchat.watch.TEST_HOOK"
