package com.pingchat.watch.testhook
        ...
        return ok("favorite_status")
            ...
            .put(
                ...
                when (identity.favoriteIndicator) {
                    com.pingchat.watch.ui.FavoriteIndicator.Favorite -> "filled"
                    com.pingchat.watch.ui.FavoriteIndicator.FavoritedUs -> "outlined_orange"
                    com.pingchat.watch.ui.FavoriteIndicator.None -> "outlined"
                }
            )
    }
