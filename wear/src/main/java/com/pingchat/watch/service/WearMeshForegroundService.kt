package com.pingchat.watch.service
...
import com.pingchat.watch.notification.WearNotificationPolicy
...
class WearMeshForegroundService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "pingchat_mesh"
    ...
    private fun handlePrivateMessage(message: PingchatMessage) {
