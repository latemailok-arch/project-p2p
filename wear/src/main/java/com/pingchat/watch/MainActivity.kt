...
import com.pingchat.watch.service.WearMeshForegroundService
import com.pingchat.watch.ui.ChatScreen
import com.pingchat.watch.ui.DmScreen
import com.pingchat.watch.ui.NicknameSetupScreen
import com.pingchat.watch.ui.PeopleScreen
import com.pingchat.watch.ui.UserDetailScreen
import com.pingchat.watch.ui.VerificationCodeScreen
import com.pingchat.watch.ui.WearChatState
import com.pingchat.watch.ui.sendPrivateMessage
import com.pingchat.watch.ui.sendPublicMessage
import com.pingchat.watch.ui.theme.BitchatWearTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nicknameChosen = getSharedPreferences("pingchat_watch_prefs", Context.MODE_PRIVATE)
            ...
            BitchatWearTheme {
                when {
                    ...
                    !nicknameChosen -> NicknameSetupScreen(
                        ...
                        getSharedPreferences("pingchat_watch_prefs", Context.MODE_PRIVATE)
    ...
    override fun onResume() {
        super.onResume()
        com.pingchat.android.features.voice.LiveVoiceManager.getInstance(applicationContext)
...
internal fun WearNavHost(
    ...
    AnimatedContent(
        ...
        transitionSpec = {
            fadeIn(tween(com.pingchat.watch.ui.theme.BitchatMotion.EMPHASIZED_MS)) togetherWith
                fadeOut(tween(com.pingchat.watch.ui.theme.BitchatMotion.QUICK_MS))
        },
        ...
        when (current) {
            ...
            is WearScreen.TextInput -> {
                ...
                com.pingchat.watch.ui.TextInputScreen(
                    onSend = { text ->
                        mesh?.let { m ->
