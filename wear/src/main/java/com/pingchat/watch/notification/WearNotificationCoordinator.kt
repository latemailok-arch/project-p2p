package com.pingchat.watch.notification
...
import com.pingchat.watch.MainActivity
...
class WearNotificationCoordinator private constructor(context: Context) {
    ...
    companion object {
        const val EXTRA_OPEN_DM = "com.pingchat.watch.extra.OPEN_DM"
        const val EXTRA_PEER_ID = "com.pingchat.watch.extra.PEER_ID"

        private const val MESSAGE_CHANNEL_ID = "pingchat_watch_messages"
