 ...
 *
 * Usage:
 *   adb shell am broadcast -a com.pingchat.droid.TEST_HOOK \
 ...
 *   adb shell run-as com.pingchat.droid cat cache/testhook/results/<id>.json
 */
class TestHookReceiver : BroadcastReceiver() {

    companion object {
        const val TAG = "TestHook"
        const val ACTION = "com.pingchat.droid.TEST_HOOK"
