package com.pingchat.android.testhook

import android.content.Context
import android.content.Intent
import android.util.Log
import com.pingchat.android.favorites.FavoritesPersistenceService
import com.pingchat.android.features.file.FileUtils
import com.pingchat.android.features.voice.LiveVoiceEvent
...
import com.pingchat.android.features.voice.LiveVoiceCapture
...
import com.pingchat.android.mesh.TransferProgressManager
...
import com.pingchat.android.service.MeshForegroundService
...
import com.pingchat.android.ui.DataManager
import com.pingchat.android.ui.PrivateMediaRecipientResolver
...
object TestHookDriver {
    ...
    private suspend fun msgRecv(context: Context, intent: Intent): JSONObject {
        ...
        val startTime = System.currentTimeMillis()
        val mesh = mesh(context)
        val matches: (com.pingchat.android.model.PingchatMessage) -> Boolean = { msg ->
            msg.timestamp.time >= startTime &&
                msg.senderPeerID != mesh.myPeerID &&
                (contains == null || msg.content.contains(contains)) &&
