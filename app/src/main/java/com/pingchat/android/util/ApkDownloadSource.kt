...
/**
 * A trusted location that serves the latest signed universal PingChat APK.
 *
    ...
    val all = listOf(
        ApkDownloadSource(
            ...
            latestApkUrls = listOf(
                "https://github.com/permissionlesstech/pingchat-android/releases/latest/" +
...
enum class ApkDownloadFailureReason(@StringRes val messageRes: Int) {
    ...
    NotPingchat(R.string.prepare_apk_error_not_PingChat),
