...
internal class GitHubReleaseClient(
    ...
    companion object {
        ...
        private const val GITHUB_API_URL =
            "https://api.github.com/repos/permissionlesstech/pingchat-android/releases/latest"
        ...
        private const val USER_AGENT = "PingChat-Android"

        private val SOURCE = ApkDownloadSource(
            id = DefaultApkDownloadSources.GITHUB_ID,
            displayName = "GitHub Releases",
            latestApkUrl = "https://github.com/permissionlesstech/pingchat-android/releases/latest/" +
                "download/pingchat-android-universal.apk"
        )
