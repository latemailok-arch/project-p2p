...
@Parcelize
enum class PingchatMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * PingchatMessage - 100% compatible with iOS version
 */
@Parcelize
data class PingchatMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: PingchatMessageType = PingchatMessageType.Message,
    val timestamp: Date,
     ...
     *
     * This is local identity metadata, not part of the PingChat binary wire format. It lets UI
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): PingchatMessage? {
            try {
                ...
                return PingchatMessage(
                    ...
                    sender = sender,
                    content = content,
                    type = PingchatMessageType.Message,
                    timestamp = timestamp,
                    isRelay = isRelay,
