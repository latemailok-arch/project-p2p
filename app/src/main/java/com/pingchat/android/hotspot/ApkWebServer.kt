...
class ApkWebServer(
    ...
    private fun serveApk(): Response {
        return try {
            ...
            response.addHeader("Content-Disposition", "attachment; filename=\"pingchat-${appVersion}.apk\"")
...
<body>
    <div class="container">
        ...
        <a href="/pingchat.apk" class="download-button">
            📥 Download PingChat
        </a>
        ...
        <div class="warning">
            ...
            If you already have PingChat installed, you may need to uninstall it first before installing this version. Make sure to backup your data if needed.
        </div>
    </div>
</body>
</html>
