...
import com.pingchat.android.features.media.ImageUtils
import com.pingchat.android.ui.ComposerActionSurface
import com.pingchat.android.ui.ComposerIconSize
import java.io.File
...
fun ImagePickerButton(
    ...
    val takePictureLauncher = rememberLauncherForActivityResult(
        ...
        if (success && !path.isNullOrBlank()) {
            ...
            val outPath = com.pingchat.android.features.media.ImageUtils.downscalePathAndSaveToAppFiles(context, path)
    ...
    ComposerActionSurface(
        ...
        Icon(
            ...
            contentDescription = stringResource(com.pingchat.android.R.string.pick_image),
            tint = tint,
