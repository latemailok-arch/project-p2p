...
import com.pingchat.android.core.ui.component.sheet.PingchatSheetCenterTopBar
...
import com.pingchat.android.favorites.FavoriteRelationship
...
import com.pingchat.android.ui.theme.BASE_FONT_SIZE
...
fun MeshPeerListSheet(
    ...
    val wifiAwareConnected by com.pingchat.android.wifiaware.WifiAwareController.connectedPeers.collectAsStateWithLifecycle()
    ...
    if (isPresented) {
        PingchatBottomSheet(
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                LazyColumn(
                    ...
                    when {
                        conversationStoreState is
                            com.pingchat.android.services.ConversationStoreState.Loading &&
                        ...
                        conversationStoreState is
                            com.pingchat.android.services.ConversationStoreState.Error &&
                            conversations.isEmpty() -> {
                ...
                PingchatSheetTopBar(
                    title = {
                        PingchatSheetTitle(text = stringResource(id = R.string.your_network))
                    },
...
private fun ConversationRow(
    ...
    val basePreview = when {
        ...
        conversation.latestMessageType == PingchatMessageType.Image ->
            stringResource(R.string.notification_sent_image)
        conversation.latestMessageType == PingchatMessageType.Audio ->
            stringResource(R.string.notification_sent_voice)
        conversation.latestMessageType == PingchatMessageType.File ->
