...
class PrivateChatManager(
    ...
    private val unreadReceivedMessages = mutableMapOf<String, MutableList<PingchatMessage>>()
    ...
    fun handleIncomingPrivateMessage(message: PingchatMessage) {
    ...
    fun sendReadReceiptsForPeer(
        ...
        val chats = try { state.getPrivateChatsValue() } catch (_: Exception) { emptyMap<String, List<PingchatMessage>>() }
