...
object MessageGrouping {
     ...
     */
    fun shouldGroup(previous: PingchatMessage?, current: PingchatMessage): Boolean {
     ...
     */
    private fun isSameSender(previous: PingchatMessage, current: PingchatMessage): Boolean {
