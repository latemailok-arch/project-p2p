...
import com.pingchat.android.geohash.DEFAULT_LIVE_LOCATION_ENABLED
...
class DataManager(private val context: Context) {
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("pingchat_prefs", Context.MODE_PRIVATE)
