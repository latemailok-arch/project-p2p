...
import com.pingchat.android.geohash.GeohashNostrPrivacyPolicy
import com.pingchat.android.geohash.LiveLocationPrivacyGate
import com.pingchat.android.nostr.GeohashMessageHandler
import com.pingchat.android.nostr.GeohashRepository
import com.pingchat.android.nostr.NostrBackgroundRuntime
import com.pingchat.android.nostr.NostrIdentityBridge
import com.pingchat.android.nostr.NostrProtocol
import com.pingchat.android.nostr.NostrRelayManager
import com.pingchat.android.nostr.NostrSubscriptionManager
import com.pingchat.android.nostr.PoWPreferenceManager
import com.pingchat.android.nostr.GeohashAliasRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.pingchat.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.pingchat.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.pingchat.android.geohash.ChannelID.Mesh)
    ...
    fun panicReset() {
        ...
        try { com.pingchat.android.nostr.NostrRelayManager.getInstance(getApplication()).clearAllOnPanic() } catch (_: Exception) {}
        try { com.pingchat.android.nostr.LocationNotesManager.getInstance().stop() } catch (_: Exception) {}
    }

    fun sendGeohashMessage(content: String, channel: com.pingchat.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.pingchat.android.model.PingchatMessage(
                    id = tempId,
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.pingchat.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.pingchat.android.model.PingchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.pingchat.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.pingchat.android.geohash.ChannelID.Mesh -> {
            ...
            is com.pingchat.android.geohash.ChannelID.Location -> {
                if (locationChannelManager?.canUseSelectedLocationChannel(channel.channel) != true) {
                    ...
                    switchLocationChannel(com.pingchat.android.geohash.ChannelID.Mesh)
                    return
                }
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        val selectedLocation = selected as? com.pingchat.android.geohash.ChannelID.Location
