 ...
 */
private fun tryOpenFile(context: Context, packet: PingchatFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("pingchat_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
