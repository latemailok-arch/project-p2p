package com.pingchat.android.noise

import android.content.Context
import android.util.Log
import com.pingchat.android.identity.SecureIdentityStateManager
import com.pingchat.android.mesh.PeerFingerprintManager
import com.pingchat.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.pingchat.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.pingchat.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.pingchat.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a PingchatPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.pingchat.android.protocol.PingchatPacket): com.pingchat.android.protocol.PingchatPacket? {
    ...
    /**
     * Verify a PingchatPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.pingchat.android.protocol.PingchatPacket, publicKey: ByteArray): Boolean {
