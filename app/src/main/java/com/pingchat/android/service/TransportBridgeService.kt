...
object TransportBridgeService {
    ...
    interface TransportLayer {
         ...
         */
        fun sendToPeer(peerID: String, packet: PingchatPacket) { }
    }
     ...
     */
    fun sendToPeer(sourceId: String, peerID: String, packet: PingchatPacket) {
        val targets = transports.filterKeys { it != sourceId }
        if (targets.isEmpty()) return
        val forwardedPacket =
     ...
     */
    fun sendToPeerFromLocal(peerID: String, packet: PingchatPacket) {
        val targets = transports.toMap()
        if (targets.isEmpty()) return
    ...
    private fun prepareForwardedPacket(kind: String, packet: PingchatPacket): PreparedForward? {
    ...
    private fun logicalPacketId(packet: PingchatPacket): String {
