...
/**
 * Owns the user-visible "pingchatters nearby" notification independently of the UI delegate.
...
internal class PeerAvailabilityNotifier(
    ...
    companion object {
        internal const val CHANNEL_ID = "pingchat_peer_availability_notifications"
