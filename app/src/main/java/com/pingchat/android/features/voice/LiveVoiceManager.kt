package com.pingchat.android.features.voice
...
class LiveVoiceManager private constructor(private val context: Context) {
    ...
    @Synchronized
    fun absorbFinalizedVoiceNote(message: PingchatMessage): Boolean {
        if (message.type != PingchatMessageType.Audio) return false
