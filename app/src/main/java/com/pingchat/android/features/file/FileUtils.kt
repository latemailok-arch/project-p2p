...
object FileUtils {
    ...
    /**
     * Classify PingchatMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.pingchat.android.model.PingchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.pingchat.android.model.PingchatMessageType.Image
            lower.startsWith("audio/") -> com.pingchat.android.model.PingchatMessageType.Audio
            else -> com.pingchat.android.model.PingchatMessageType.File
        }
    }
    ...
    fun deleteConversationMedia(
        context: Context,
        deletedMessages: Collection<PingchatMessage>,
        retainedMessages: Collection<PingchatMessage>
    ) {
