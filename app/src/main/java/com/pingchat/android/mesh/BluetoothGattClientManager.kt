...
import com.pingchat.android.ui.debug.DebugSettingsManager
import com.pingchat.android.ui.debug.DebugScanResult
...
class BluetoothGattClientManager(
    ...
    private fun handleScanResult(result: ScanResult) {
        ...
        val dbg = try { com.pingchat.android.ui.debug.DebugSettingsManager.getInstance() } catch (_: Exception) { null }
    ...
    private fun connectToDevice(device: BluetoothDevice, rssi: Int, peerID: String? = null) {
        ...
        Log.d(TAG, "Connecting to pingchat device: $deviceAddress (peerID: $peerID)")
        ...
        val gattCallback = object : BluetoothGattCallback() {
            ...
            override fun onCharacteristicChanged(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic) {
                ...
                val packet = PingchatPacket.fromBinaryData(value)
                if (packet != null) {
