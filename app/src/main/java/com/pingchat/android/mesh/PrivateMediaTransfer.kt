...
internal data class BuiltPrivateMediaTransfer(
    ...
    val fragments: List<PingchatPacket>,
    val wireMode: PrivateMediaWireMode
)
...
internal class PrivateMediaTransferPreparer(
    ...
    private val finalizeRoutedAndSigned: (PingchatPacket) -> PingchatPacket?,
    private val fragment: (PingchatPacket, Int) -> List<PingchatPacket>,
    ...
    private fun prepare(
        ...
        val maxPrivateFragments =
            com.pingchat.android.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
        val absolutePayloadUpperBound =
            maxPrivateFragments.toLong() *
                com.pingchat.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE.toLong()
        ...
        val packet = when (mode) {
            ...
            PrivateMediaWireMode.SIGNED_DIRECTED_RAW_0X22 -> PingchatPacket(
                version = 2u,
