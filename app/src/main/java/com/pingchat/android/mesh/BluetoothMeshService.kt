...
import com.pingchat.android.crypto.EncryptionService
import com.pingchat.android.model.PingchatMessage
import com.pingchat.android.model.AuthenticatedPeerState
import com.pingchat.android.model.PeerCapabilities
import com.pingchat.android.protocol.MessagePadding
import com.pingchat.android.model.RoutedPacket
import com.pingchat.android.model.IdentityAnnouncement
import com.pingchat.android.model.NoisePayload
...
import com.pingchat.android.protocol.SpecialRecipients
import com.pingchat.android.model.RequestSyncPacket
import com.pingchat.android.sync.GossipSyncManager
import com.pingchat.android.util.toHexString
import com.pingchat.android.services.VerificationService
import com.pingchat.android.service.TransportBridgeService
...
class BluetoothMeshService(private val context: Context) : TransportBridgeService.TransportLayer {
    private val debugManager by lazy { try { com.pingchat.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    
    companion object {
        private const val TAG = "BluetoothMeshService"
        private val MAX_TTL: UByte = com.pingchat.android.util.AppConstants.MESSAGE_TTL_HOPS
        private const val PEER_DISCONNECT_GRACE_MS = com.pingchat.android.util.AppConstants.Mesh.PEER_DISCONNECT_GRACE_MS
    }
    ...
    private val privateMediaPreparer by lazy {
        PrivateMediaTransferPreparer(
            ...
            encrypt = { plaintext, peerID, authenticatedSession ->
                ...
                } catch (_: com.pingchat.android.noise.NoiseSessionError.SessionGenerationChanged) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: com.pingchat.android.noise.NoiseSessionError.SessionNotFound) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: com.pingchat.android.noise.NoiseSessionError.SessionNotEstablished) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: Exception) {
    ...
    private val serviceNotificationManager = com.pingchat.android.ui.NotificationManager(
    ...
    init {
        ...
        encryptionService.onSessionEstablished = { peerID ->
            ...
            try {
                com.pingchat.android.services.MessageRouter
                    .tryGetInstance()
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.pingchat.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.pingchat.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.pingchat.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
                } catch (_: Exception) { 0.01 }
            }
        )

        com.pingchat.android.service.MeshServiceHolder.setGossipManager(gossipSyncManager) { packet ->
    ...
    override fun sendToPeer(peerID: String, packet: PingchatPacket) {
        if (!isBleTransportEnabled()) return
    ...
    private fun isBleTransportEnabled(): Boolean {
        return try {
            com.pingchat.android.ui.debug.DebugSettingsManager.getInstance().bleEnabled.value
        } catch (_: Exception) {
            try { com.pingchat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        }
    }
    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            override fun onPeerListUpdated(peerIDs: List<String>) {
                ...
                try { com.pingchat.android.services.AppStateStore.setTransportPeers("BLE", peerIDs) } catch (_: Exception) { }
            ...
            override fun onPeerRemoved(peerID: String) {
                ...
                try { com.pingchat.android.services.meshgraph.MeshGraphService.getInstance().removePeer(peerID) } catch (_: Exception) { }
        ...
        securityManager.delegate = object : SecurityManagerDelegate {
            ...
            override fun sendHandshakeResponse(peerID: String, response: ByteArray) {
                ...
                val responsePacket = PingchatPacket(
                    version = 1u,
        ...
        storeForwardManager.delegate = object : StoreForwardManagerDelegate {
            ...
            override fun sendPacket(packet: PingchatPacket) {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerInfoFromVerifiedAnnouncement(peerID: String, nickname: String, noisePublicKey: ByteArray, signingPublicKey: ByteArray, isVerified: Boolean, capabilities: com.pingchat.android.model.PeerCapabilities?): Boolean {
            ...
            override fun verifySignature(packet: PingchatPacket, peerID: String): Boolean {
            ...
            override fun decryptFromPeer(
                ...
                senderPeerID: String
            ): com.pingchat.android.noise.NoiseDecryptionResult? {
            ...
            override fun onAuthenticatedPeerStateReceived(
                ...
                authenticatedSession: com.pingchat.android.noise.AuthenticatedNoiseSession
            ) {
            ...
            // Callbacks
            override fun onMessageReceived(message: PingchatMessage) {
                ...
                if (
                    !com.pingchat.android.services.IncomingMessageAdmission
                ...
                if (delegate == null && message.isPrivate && message.sender != "system") {
                    try {
                        ...
                        if (senderPeerID != null) {
                            ...
                            val preview = com.pingchat.android.ui.NotificationTextUtils.buildPrivateMessagePreview(message)
            ...
            override fun onDeliveryAckReceived(messageID: String, peerID: String) {
                ...
                try {
                    com.pingchat.android.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        com.pingchat.android.model.DeliveryStatus.Delivered(peerID, Date())
                    )
                } catch (_: Exception) { }
            ...
            override fun onReadReceiptReceived(messageID: String, peerID: String) {
                try {
                    com.pingchat.android.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        com.pingchat.android.model.DeliveryStatus.Read(peerID, Date())
                    )
                } catch (_: Exception) { }
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: PingchatPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: PingchatPacket): PingchatPacket? {
        ...
        override fun onPacketReceived(
            ...
            try {
                com.pingchat.android.ui.debug.DebugSettingsManager.getInstance().logIncoming(
                    packet = packet,
                    fromPeerID = peerID,
                    fromNickname = null,
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.pingchat.android.ui.debug.DebugSettingsManager.getInstance()
    ...
    fun startServices() {
        ...
        if (!isBleTransportEnabled()) {
            ...
            com.pingchat.android.service.MeshServiceHolder.stopSharedGossip("BLE")
            try { com.pingchat.android.services.AppStateStore.clearTransportPeers("BLE") } catch (_: Exception) { }
            try { com.pingchat.android.services.AppStateStore.clearTransportDirectPeers("BLE") } catch (_: Exception) { }
            return
        }
        if (terminated) {
        ...
        if (connectionManager.startServices()) {
            ...
            com.pingchat.android.service.MeshServiceHolder.startSharedGossip("BLE")
        } else {
    ...
    fun sendFileBroadcast(file: com.pingchat.android.model.PingchatFilePacket) {
        try {
    ...
    fun sendFilePrivate(recipientPeerID: String, file: com.pingchat.android.model.PingchatFilePacket) {
    ...
    fun prepareFilePrivate(
        ...
        file: com.pingchat.android.model.PingchatFilePacket,
        transferId: String,
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.pingchat.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.pingchat.android.model.NoisePayload(
                        type = com.pingchat.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.pingchat.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.pingchat.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.pingchat.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }

            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = com.pingchat.android.model.NoisePayload(
                    type = com.pingchat.android.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = PingchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.pingchat.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
                ...
                readReceiptRetrySender.enqueue(
                    ...
                    onComplete = { accepted ->
                        if (accepted) {
                            try {
                                com.pingchat.android.services.SeenMessageStore
    ...
    fun sendBroadcastAnnounce() {
        serviceScope.launch {
            val nickname = try { com.pingchat.android.services.NicknameProvider.getNickname(context, myPeerID) } catch (_: Exception) { myPeerID }
            ...
            try {
                ...
                if (directPeers.isNotEmpty()) {
                    val gossip = com.pingchat.android.services.meshgraph.GossipTLV.encodeNeighbors(directPeers)
                    tlvPayload = tlvPayload + gossip
                }
                // Always update our own node in the mesh graph with the neighbor list we used
                try {
                    com.pingchat.android.services.meshgraph.MeshGraphService.getInstance()
                        .updateFromAnnouncement(myPeerID, nickname, directPeers, System.currentTimeMillis().toULong())
                } catch (_: Exception) { }
            } catch (_: Exception) { }
            
            val announcePacket = PingchatPacket(
    ...
    private fun getDirectPeerIDsForGossip(): List<String> {
        return try {
            ...
            try { com.pingchat.android.services.AppStateStore.setTransportDirectPeers("BLE", direct) } catch (_: Exception) { }
            val union = try {
                com.pingchat.android.services.AppStateStore.getDirectPeers().ifEmpty { direct }
     ...
     */
    fun getSessionState(peerID: String): com.pingchat.android.noise.NoiseSession.NoiseSessionState {
     ...
     */
    private fun applyRouteIfAvailable(packet: PingchatPacket): PingchatPacket {
        return try {
            ...
            if (recipient != null && !recipient.contentEquals(SpecialRecipients.BROADCAST)) {
                ...
                val path = com.pingchat.android.services.meshgraph.RoutePlanner.shortestPath(
                    myPeerID,
                    destination
                )
    ...
    private fun routeAndSignPrivateMediaStrict(packet: PingchatPacket): PingchatPacket? {
    ...
    private fun signPacketBeforeBroadcast(packet: PingchatPacket): PingchatPacket {
        return try {
