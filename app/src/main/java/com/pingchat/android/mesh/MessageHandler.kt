...
import com.pingchat.android.favorites.FavoriteControlMessage
...
import com.pingchat.android.sync.PacketIdUtil
import com.pingchat.android.util.toHexString
import com.pingchat.android.features.voice.LiveVoiceManager
import com.pingchat.android.features.voice.LiveVoiceScope
...
class MessageHandler(private val myPeerID: String, private val appContext: android.content.Context) {
    ...
    suspend fun handleNoiseEncrypted(routed: RoutedPacket): Boolean {
        ...
        try {
            ...
            val noisePayload = com.pingchat.android.model.NoisePayload.decode(decryptedData)
            ...
            when (noisePayload.type) {
                com.pingchat.android.model.NoisePayloadType.PRIVATE_MESSAGE -> {
                    // Decode TLV private message exactly like iOS
                    val privateMessage = com.pingchat.android.model.PrivateMessagePacket.decode(noisePayload.data)
                    if (privateMessage != null) {
                        ...
                        // Create PingchatMessage - preserve source packet timestamp
                ...
                com.pingchat.android.model.NoisePayloadType.FILE_TRANSFER -> {
                    // Handle encrypted file transfer; generate unique message ID
                    val file = com.pingchat.android.model.PingchatFilePacket.decode(noisePayload.data)
                    if (file != null) {
                        Log.d(TAG, "Encrypted file from $peerID: ${file.fileSize} bytes")
                        val uniqueMsgId = java.util.UUID.randomUUID().toString().uppercase()
                        val savedPath = com.pingchat.android.features.file.FileUtils.saveIncomingFile(appContext, file)
                        val message = PingchatMessage(
                            id = uniqueMsgId,
                            sender = delegate?.getPeerNickname(peerID) ?: "Unknown",
                            content = savedPath,
                            type = com.pingchat.android.features.file.FileUtils.messageTypeForMime(file.mimeType),
                            timestamp = java.util.Date(packet.timestamp.toLong()),
                            isRelay = false,
                            isPrivate = true,
                            recipientNickname = delegate?.getMyNickname(),
                ...
                com.pingchat.android.model.NoisePayloadType.VOICE_FRAME -> {
                ...
                com.pingchat.android.model.NoisePayloadType.PEER_STATE -> {
                ...
                com.pingchat.android.model.NoisePayloadType.DELIVERED -> {
                ...
                com.pingchat.android.model.NoisePayloadType.READ_RECEIPT -> {
                ...
                com.pingchat.android.model.NoisePayloadType.VERIFY_CHALLENGE -> {
                    delegate?.onVerifyChallengeReceived(peerID, noisePayload.data, packet.timestamp.toLong())
                }
                com.pingchat.android.model.NoisePayloadType.VERIFY_RESPONSE -> {
    ...
    private suspend fun sendDeliveryAck(messageID: String, senderPeerID: String) {
        try {
            ...
            val ackPayload = com.pingchat.android.model.NoisePayload(
                type = com.pingchat.android.model.NoisePayloadType.DELIVERED,
    ...
    suspend fun handleAnnounceWithResult(routed: RoutedPacket): AnnounceHandlingResult {
        ...
        try {
            val neighborsOrNull = com.pingchat.android.services.meshgraph.GossipTLV.decodeNeighborsFromAnnouncementPayload(packet.payload)
        ...
        try {
            ...
            if (response != null) {
                ...
                val responsePacket = PingchatPacket(
                    ...
                    payload = response,
                    signature = null,
                    ttl = com.pingchat.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS
                )
    ...
    private suspend fun handleBroadcastMessage(routed: RoutedPacket) {
        ...
        try {
            ...
            val isFileTransfer = com.pingchat.android.protocol.MessageType.fromValue(packet.type) == com.pingchat.android.protocol.MessageType.FILE_TRANSFER
            val file = com.pingchat.android.model.PingchatFilePacket.decode(packet.payload)
            if (file != null) {
     ...
     */
    private suspend fun handlePrivateMessage(packet: PingchatPacket, peerID: String) {
        try {
            val isFileTransfer = com.pingchat.android.protocol.MessageType.fromValue(packet.type) ==
                com.pingchat.android.protocol.MessageType.FILE_TRANSFER
    ...
    private fun handleFavoriteNotificationFromMesh(content: String, fromPeerID: String) {
        try {
            ...
            if (noiseKey != null) {
                com.pingchat.android.favorites.FavoritesPersistenceService.shared.updatePeerFavoritedUs(noiseKey, control.isFavorite)
                if (control.npub != null) {
                    com.pingchat.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKey(noiseKey, control.npub)
                    com.pingchat.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(fromPeerID, control.npub)
                }

                val rel = com.pingchat.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey)
                ...
                val sys = com.pingchat.android.model.PingchatMessage(
                    sender = "system",
                    content = notice,
                ...
                try {
                    val conversationID = com.pingchat.android.services.ContactDirectory
                        .canonicalConversationId(fromPeerID)
                    val sysPrivate = com.pingchat.android.model.PingchatMessage(
                        sender = "system",
                        content = notice,
                        timestamp = java.util.Date(),
                        isRelay = false,
...
interface MessageHandlerDelegate {
    ...
    fun updatePeerInfoFromVerifiedAnnouncement(
        ...
        isVerified: Boolean,
        capabilities: com.pingchat.android.model.PeerCapabilities? = null
    ): Boolean
    
    // Packet operations
    fun sendPacket(packet: PingchatPacket)
    fun relayPacket(routed: RoutedPacket)
    fun getBroadcastRecipient(): ByteArray
    
    // Cryptographic operations
    fun verifySignature(packet: PingchatPacket, peerID: String): Boolean
    ...
    // Callbacks
    fun onMessageReceived(message: PingchatMessage)
