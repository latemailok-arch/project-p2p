 ...
 * 
 * This class handles all relay decisions and logic for pingchat packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.pingchat.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: PingchatPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: PingchatPacket, fromPeerID: String): Boolean {
