...
import com.pingchat.android.onboarding.BluetoothCheckScreen
import com.pingchat.android.onboarding.BluetoothStatus
import com.pingchat.android.onboarding.BluetoothStatusManager
import com.pingchat.android.onboarding.BatteryOptimizationManager
import com.pingchat.android.onboarding.BatteryOptimizationPreferenceManager
import com.pingchat.android.onboarding.BatteryOptimizationScreen
import com.pingchat.android.onboarding.BatteryOptimizationStatus
import com.pingchat.android.onboarding.BackgroundLocationPermissionScreen
import com.pingchat.android.onboarding.InitializationErrorScreen
import com.pingchat.android.onboarding.InitializingScreen
import com.pingchat.android.onboarding.LocationCheckScreen
import com.pingchat.android.onboarding.LocationStatus
import com.pingchat.android.onboarding.LocationStatusManager
import com.pingchat.android.onboarding.OnboardingCoordinator
import com.pingchat.android.onboarding.OnboardingState
import com.pingchat.android.onboarding.PermissionExplanationScreen
import com.pingchat.android.onboarding.PermissionManager
import com.pingchat.android.ui.ChatScreen
import com.pingchat.android.ui.ChatViewModel
import com.pingchat.android.ui.OrientationAwareActivity
import com.pingchat.android.ui.theme.PingchatTheme
import com.pingchat.android.wifiaware.WifiAwareController
import com.pingchat.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.pingchat.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.pingchat.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.pingchat.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.pingchat.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        meshService = com.pingchat.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        unifiedMeshService = com.pingchat.android.service.MeshServiceHolder.getUnifiedOrCreate(applicationContext)
        ...
        // Init PingChat discord stores (color options, username)
        com.pingchat.android.ui.discord.ColorOptionsStore.init(this)
        com.pingchat.android.ui.discord.UsernameManager.init(this)
    ...
    private fun OnboardingFlowScreen(modifier: Modifier = Modifier) {
        ...
        when (onboardingState) {
            ...
            OnboardingState.CHECKING, OnboardingState.INITIALIZING, OnboardingState.COMPLETE -> {
                ...
                // Discord UI - completely replaces old linear UI with bubble 3D + color options + username/groups
                com.pingchat.android.ui.discord.DiscordChatScreen(viewModel = chatViewModel)
            }
    ...
    private fun checkBluetoothAndProceed() {
        ...
        val bleRequired = try { com.pingchat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        if (!bleRequired) {
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.pingchat.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun handleLocationEnabled() {
        ...
        com.pingchat.android.wifiaware.WifiAwareController.startIfPossible()
        checkBatteryOptimizationAndProceed()
    }
    ...
    private fun handleOnboardingComplete() {
        ...
        val bleRequired2 = try { com.pingchat.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        when {
    ...
    private fun startMeshForegroundServiceBestEffort() {
        ...
        try {
            com.pingchat.android.service.MeshForegroundService.start(applicationContext)
    ...
    private fun initializeApp() {
        lifecycleScope.launch {
            try {
                ...
                com.pingchat.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.pingchat.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.pingchat.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.pingchat.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.pingchat.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.pingchat.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.pingchat.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.pingchat.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.pingchat.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.pingchat.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.pingchat.android.geohash.GeohashChannelLevel.REGION
                        else -> com.pingchat.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.pingchat.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.pingchat.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "pingchat" || uri.host != "verify") return
