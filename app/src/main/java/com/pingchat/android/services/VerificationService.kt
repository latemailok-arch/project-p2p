...
object VerificationService {
    private const val CONTEXT = "pingchat-verify-v1"
    private const val RESPONSE_CONTEXT = "pingchat-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "pingchat" || uri.host != "verify") return null
