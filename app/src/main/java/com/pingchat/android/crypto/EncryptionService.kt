package com.pingchat.android.crypto
...
import com.pingchat.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in pingchat.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "pingchat_crypto"
        private const val SECURE_PREFS_NAME = "pingchat_crypto_secure"
    }
