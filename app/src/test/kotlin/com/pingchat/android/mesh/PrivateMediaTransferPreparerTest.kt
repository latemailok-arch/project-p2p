...
class PrivateMediaTransferPreparerTest {
    ...
    fun `impossible content size rejects before policy encryption signing or fragmentation`() {
        ...
        val absolutePayloadUpperBound =
            com.pingchat.android.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID *
                com.pingchat.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE
        val preparer = PrivateMediaTransferPreparer(
            senderID = senderID,
            ttl = 7u,
            policyProvider = {
    ...
    private fun preparer(
        ...
        finalizer: (PingchatPacket) -> PingchatPacket? = { packet ->
    ...
    private fun file(size: Int) = PingchatFilePacket(
        fileName = "test.bin",
