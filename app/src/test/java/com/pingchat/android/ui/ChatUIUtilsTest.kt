...
import com.pingchat.android.ui.theme.DarkPingchatColorScheme
import com.pingchat.android.ui.theme.DarkPingchatPalette
import com.pingchat.android.ui.theme.LightPingchatColorScheme
import com.pingchat.android.ui.theme.LightPingchatPalette
import com.pingchat.android.ui.theme.MessageBodyTextStyle
import com.pingchat.android.ui.theme.MessageSenderTextStyle
import com.pingchat.android.ui.theme.PeerColorStyle
...
class ChatUIUtilsTest {
    ...
    private val palette = DarkPingchatPalette
    private val colorScheme = DarkPingchatColorScheme
    ...
    fun `chat text styles match the exported type scale`() {
        ...
        assertEquals(PingchatFontFamily, MessageBodyTextStyle.fontFamily)
    ...
    fun `peer color hue is stable across light and dark, only chroma differs`() {
        ...
        val dark = colorForPeer(identity, DarkPingchatPalette)
        val light = colorForPeer(identity, LightPingchatPalette)
    ...
    fun `material owns standard text while Bitchat palette owns peer chroma`() {
        assertEquals(Color(0xFFF5F5F5), DarkPingchatColorScheme.onSurface)
        assertTrue(LightPingchatColorScheme.onSurface != DarkPingchatColorScheme.onSurface)
        assertTrue(
            LightPingchatPalette.peerColors != DarkPingchatPalette.peerColors
        )
    }
